...
import "@/assets/BreakupSuccessModal.css"
...
export const BreakupSuccessModal: React.FC<BreakupSuccessModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm breakup-success-modal-backdrop flex items-center justify-center p-4">
        <motion.div
          initial={{ scale: 0.8, opacity: 0, y: 30 }}
          animate={{ scale: 1, opacity: 1, y: 0 }}
          exit={{ scale: 0.8, opacity: 0, y: 30 }}
          className="breakup-success-modal-container"
        >
          <Card className="breakup-success-modal-card border-[var(--color-success)]/30">
