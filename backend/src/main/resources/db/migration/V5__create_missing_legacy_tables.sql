-- This script creates all tables that were part of the initial schema (V1) but may be missing
-- from a database that was baselined. Using "CREATE TABLE IF NOT EXISTS" makes this script safe to run.

-- Trades and Trade Items (depends on users, shop_items, item_instances)
...
-- Case Items (depends on shop_items)
...
-- Pairings (depends on achievements)
