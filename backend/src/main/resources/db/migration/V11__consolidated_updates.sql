-- V11: Consolidated Schema Updates
-- This migration combines changes from V9 and V10 into a single, clean migration.
-- This was done to resolve a checksum mismatch error during development.
-- It includes the drop of 'pending_role_selections' and comprehensive schema updates.
--
-- =============================================================================
